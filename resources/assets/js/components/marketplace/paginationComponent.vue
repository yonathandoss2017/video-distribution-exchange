<template>
	<div class="col-md-6 filter-menu-pagination" v-if="totalVideos !== 0">
        ...
        <div class="dataTables_paginate paging_simple_numbers">
            <ul class="pagination">
                <li class="paginate_button previous disabled" v-if="page !== 0"><a href="#" v-on:click.prevent="goTo(0)"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a></li>
                <li class="paginate_button" v-if="page !== 0"><a href="#" v-on:click.prevent="goTo(page-1)"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
                ...
                <li class="paginate_button" v-if="page !== (totalPages-1)"><a href="#" v-on:click.prevent="goTo(page+1)"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                <li class="paginate_button next" id="editable_next" v-if="page !== (totalPages-1)"><a href="#" v-on:click.prevent="goTo(totalPages-1)"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            </ul>
