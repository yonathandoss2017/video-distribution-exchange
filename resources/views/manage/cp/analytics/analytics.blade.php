...
@push('title')
{{ __('app.title') }} | {{ __('manage/cp/reports/analytics.analytics') }}
@endpush
...
<div class="container">
        <div class="row">
            <div class="col-md-12">
              <div class="title-header">
                <div class="min-menu row">
                  <div class="col-md-3">
                    <div class="title">{{ __('manage/cp/reports/analytics.analytics') }}</div>
                  </div>
                  <div class="col-md-9">
                    <div class="right-panel">
                      <button onclick="exportExcel()" class="btn btn-normal btn-m">{{ __('manage/cp/reports/analytics.export_to_xls') }}</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="ibox-content">
                  <form name="analytics-filter" method="get" class="form-horizontal analytics-form" action="">
                    <div class="form-group row">
                      <label for="example-date-input" class="col-md-2 grid-c control-label">{{ __('manage/cp/reports/analytics.date_from') }}</label>
                      <div class="col-md-4 grid-c ">
                        <input class="form-control " type="date" name="start_date" value="2018-09-11" id="example-date-input">
                      </div>
                      <label for="example-date-input" class="col-md-2 grid-c control-label">{{ __('manage/cp/reports/analytics.date_to') }}</label>
                      <div class="col-md-4 grid-c ">
              ...
              <div class="form-save">
                <button id="form-submit" type="submit" class="btn btn-secondary">{{ __('manage/cp/reports/analytics.update') }}</button>
              </div>
            </div>
                ...
                <div class="ibox">
                    <div class="ibox-content row">
                        ...
                        <div class="col-md-9 right">
                            {{ __('manage/cp/reports/analytics.video_views') }}
            ...
            <div class="col-md-4 m-t">
                <div class="ibox">
                    <div class="ibox-content row">
                        ...
                        <div class="col-md-9 right">
                            {{ __('manage/cp/reports/analytics.bandwidth') }}
            ...
            <div class="col-md-4 m-t">
                <div class="ibox">
                    <div class="ibox-content row">
                        ...
                        <div class="col-md-9 right">
                            {{ __('manage/cp/reports/analytics.average_view_time') }}
            ...
            <div class="col-md-4">
                <div class="ibox no-m-t">
                    <div class="ibox-content row">
                        ...
                        <div class="col-md-9 right">
                            {{ __('manage/cp/reports/analytics.service_providers') }}
            ...
            <div class="col-md-4">
                <div class="ibox no-m-t">
                    <div class="ibox-content row">
                        ...
                        <div class="col-md-9 right">
                            {{ __('manage/cp/reports/analytics.total_playlists') }}
            ...
            <div class="col-md-4">
                <div class="ibox no-m-t">
                    <div class="ibox-content row">
                        ...
                        <div class="col-md-9 right">
                            {{ __('manage/cp/reports/analytics.total_videos') }}
            ...
            <div class="col-md-3 grid-2">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>{{ __('manage/cp/reports/analytics.new_returning') }}</h5>
                    </div>
                    <div class="ibox-content">
                        <div>
                            ...
                            <div class="m-t legend-width">
                                    ...
                                    <small><div class="square-box green"></div>{{ __('manage/cp/reports/analytics.returning_visitor') }}</small>
                                </div>
                                                            <div class="">
                                    <small><div class="square-box grey"></div>{{ __('manage/cp/reports/analytics.new_visitor') }}</small>
                                </div>
                                                        </div>
                        </div>
                    </div>
            ...
            <div class="col-md-3 grid-2">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>{{ __('manage/cp/reports/analytics.age_groups') }}</h5>
                    </div>
                    <div class="ibox-content">
                        <div>
            ...
            <div class="col-md-3 grid-2">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>{{ __('manage/cp/reports/analytics.genders') }}</h5>
                    </div>
                    <div class="ibox-content">
                        <div>
                            ...
                            <div class="m-t legend-width">
                                                                    <div class="status-float m-r">
                                        <small><div class="square-box green"></div>{{ __('manage/cp/reports/analytics.male') }}</small>
                                    </div>
                                                                    <div class="">
                                        <small><div class="square-box grey"></div>{{ __('manage/cp/reports/analytics.female') }}</small>
                                    </div>
                                                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-3 grid-2">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>{{ __('manage/cp/reports/analytics.device_categories') }}</h5>
                    </div>
                    <div class="ibox-content">
                        <div>
                            ...
                            <div class="m-t legend-width">
                                                                    <div class="status-float m-r">
                                        <small><div class="square-box green"></div>{{ __('manage/cp/reports/analytics.desktop') }}</small>
                                    </div>
                                                                    <div class="status-float m-r">
                                        <small><div class="square-box grey"></div>{{ __('manage/cp/reports/analytics.mobile') }}</small>
                                    </div>
                                                                    <div class="">
                                        <small><div class="square-box red"></div>{{ __('manage/cp/reports/analytics.tablet') }}</small>
                                    </div>
                                                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-3 grid-2">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>{{ __('manage/cp/reports/analytics.social_networks') }}</h5>
                    </div>
                    <div class="ibox-content">
                        <div>
                            ...
                            <div class="m-t legend-width">
                                                                    <div class="status-float m-r">
                                        <small><div class="square-box green"></div>{{ __('manage/cp/reports/analytics.facebook') }}</small>
                                    </div>
                                                                    <div class="status-float m-r">
                                        <small><div class="square-box grey"></div>{{ __('manage/cp/reports/analytics.not_set') }}</small>
                                    </div>
                                                                    <div class="">
                                        <small><div class="square-box red"></div>{{ __('manage/cp/reports/analytics.google_plus') }}</small>
                                    </div>
                                                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12 m-t-2"><div class="title-header"><div class="title">{{ __('manage/cp/reports/analytics.overview') }}</div></div></div>
                    ...
                    <div class="ibox-content">
                        <div class="playlist-list">
                            <table class="table table-hover">
                                <thead>
                                <tr>
                                    <th class="playlist-title pl">{{ __('manage/cp/reports/analytics.countries') }}</th>
                                    <th class="right">{{ __('manage/cp/reports/analytics.views') }}</th>
                                    <th>{{ __('manage/cp/reports/analytics.views') }} (%)</th>
                                </tr>
                                </thead>
                                <tbody>
                                                                    <tr>
                    ...
                    <div class="ibox-content">
                        <div class="playlist-list">
                            <table class="table table-hover">
                                <thead>
                                <tr>
                                    <th class="playlist-title pl">{{ __('manage/cp/reports/analytics.browsers') }}</th>
                                    <th class="right">{{ __('manage/cp/reports/analytics.views') }}</th>
                                    <th>{{ __('manage/cp/reports/analytics.views') }} (%)</th>
                                </tr>
                                </thead>
                    ...
                    <div class="ibox-content">
                        <div class="playlist-list">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <th class="right">#</th>
                                    <th class="playlist-title pl">{{ __('manage/cp/reports/analytics.top_sp') }}</th>
                                    <th class="right">{{ __('manage/cp/reports/analytics.video_views') }}</th>
                                    <th class="right">{{ __('manage/cp/reports/analytics.video_views_midpoint') }}</th>
                                    <th>{{ __('manage/cp/reports/analytics.video_views_complete') }}</th>
                                </tr>
                                </thead>
                                <tbody>
                                    <tr>
                    ...
                    <div class="ibox-content">
                        <div class="playlist-list">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <th class="right">#</th>
                                    <th class="playlist-title pl">{{ __('manage/cp/reports/analytics.top_playlists') }}</th>
                                    <th class="right">{{ __('manage/cp/reports/analytics.video_views') }}</th>
                                    <th class="right">{{ __('manage/cp/reports/analytics.video_views_midpoint') }}</th>
                                    <th>{{ __('manage/cp/reports/analytics.video_views_complete') }}</th>
                                </tr>
                    ...
                    <div class="ibox-content">
                        <div class="playlist-list video-listing">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <th class="right">#</th>
                                    <th class="playlist-title pl">{{ __('manage/cp/reports/analytics.top_videos') }}</th>
                                    <th class="right">{{ __('manage/cp/reports/analytics.video_views') }}</th>
                                    <th class="right">{{ __('manage/cp/reports/analytics.video_views_midpoint') }}</th>
                                    <th>{{ __('manage/cp/reports/analytics.video_views_complete') }}</th>
                                </tr>
