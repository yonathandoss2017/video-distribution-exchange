        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="form">
                    ...
                    {!! Form::open(['route' => ['manage.cp.exchange.distribution.regions.store', $property_id, $id], 'method' => 'post', 'class'=>'form-horizontal']) !!}
                        <div class="ibox">
                        ...
                        <div id="term_info">
                            @include('manage.cp.exchange.distribution.regions.term', ['isEdit' => false, 'show_date' => true])
                        </div>
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control-area" name="extra_terms" id="extra_terms" rows="8">{{ old('extra_terms') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
