            ...
            <div class="col-md-8 offset-md-2">
                <div class="form">
                    <div class="title-header">
                        <a href="{{ route('manage.cp.exchange.distribution.edit', [$property_id, $summary->id]) }}" class="btn btn-normal btn-m">{{ __('manage/cp/exchange/distribution.back_to_terms_of_distribution') }}</a>
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            <div class="form-group row {{ $errors->has('name') ? " has-danger" : "" }}">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="name" value="{{ !empty(old('name')) ? old('name') : $summary->name }}" placeholder="{{ __('manage/cp/exchange/distribution.terms_of_distribution') }} #1245" tabindex="1">
...
@push('js')
    ...
    <script>
        ...
        var contract_filename = '{{ $summary->contract_name }}';
        if (contract_filename) {
            $('.custom-file div').find('input').val(contract_filename);
        }
    </script>
    <script>
