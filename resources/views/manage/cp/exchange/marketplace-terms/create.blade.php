...
@push('title')
    {{ __('app.title') }} | {{ __('manage/cp/exchange/marketplace_terms.create_marketplace_terms') }}
@endpush
    ...
    <div class="row">
        ...
        <div class="form">
            <div class="title-header ">
                ...
                <div class="title">{{ __('manage/cp/exchange/marketplace_terms.create_marketplace_terms') }}</div>
            </div>
            {!! Form::open(['route' => ['manage.cp.exchange.marketplace-terms.store', $property_id], 'method' => 'post', 'class'=>'form-horizontal']) !!}
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <div class="form-group row {{ $errors->has('name') ? " has-danger" : "" }}">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="name" value="{{ old('name') }}" tabindex="1" required>
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="payment_mode" value="revenue-share" class="custom-control-input" required onclick="showPaymentDetail()" {{ 'revenue-share' == old('payment_mode') ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="payment_mode" value="charge-download" class="custom-control-input" required onclick="showPaymentDetail()" {{ 'charge-download' == old('payment_mode') ? 'checked' : '' }}>
                                        <span class="custom-control-indicator"></span>
                                ...
                                <div class="col-md-4">
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="payment_mode" value="annual-download" class="custom-control-input" required onclick="showPaymentDetail()" {{ 'annual-download' == old('payment_mode') ? 'checked' : '' }}>
                                        <span class="custom-control-indicator"></span>
                                ...
                                <div class="col-md-4">
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="payment_mode" value="monthly-download" class="custom-control-input" required onclick="showPaymentDetail()" {{ 'monthly-download' == old('payment_mode') ? 'checked' : '' }}>
                                        <span class="custom-control-indicator"></span>
                                ...
                                <div class="col-md-4">
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="payment_mode" value="free-download" class="custom-control-input" required onclick="showPaymentDetail()" {{ 'free-download' == old('payment_mode') ? 'checked' : '' }}>
                                        <span class="custom-control-indicator"></span>
                        ...
                        <div class="form-group hidden revenue-share charge-download annual-download monthly-download row{{ $errors->has('exclusivity') ? " has-danger" : "" }}">
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="custom-control custom-radio">
                                            <input type="radio" name="exclusivity" value="exclusive" {{ 'exclusive' == old('exclusivity') ? 'checked' : '' }} class="custom-control-input" required>
                                            <span class="custom-control-indicator"></span>
                                    ...
                                    <div class="col-md-4">
                                        <label class="custom-control custom-radio">
                                            <input type="radio" name="exclusivity" value="non-exclusive" {{ 'non-exclusive' == old('exclusivity') ? 'checked' : '' }} class="custom-control-input" required>
                                            <span class="custom-control-indicator"></span>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-5 business-terms-column">
                                        ...
                                        <input class="form-control short-3 revenue_share" name="revenue_share_cp" value="{{ old('revenue_share_cp') }}" type="number" min="0" max="100" required>
                                    ...
                                    <div class="col-md-5 business-terms-column">
                                        ...
                                        <input class="form-control short-3 revenue_share" name="revenue_share_sp" value="{{ old('revenue_share_sp') }}" type="number" min="0" max="100" required>
                                        <label class="control-label t-a-l business-terms-label">%</label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-5 business-terms-column">
                                        ...
                                        <input class="form-control short-3" name="update_count" value="{{ old('update_count') }}" type="number" min="0" required>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-5 business-terms-column">
                                        ...
                                        <input class="form-control short-3" name="price" value="{{ old('price') }}" type="number" min="0" required>
                                        <label class="control-label t-a-l business-terms-label">￥</label>
                                    </div>
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control-area" name="payment_comments" id="footnote" rows="3">{{ old('payment_comments') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <div class="form-group row{{ $errors->has('api_share_to') ? " has-danger" : "" }}" id="api_share" style="margin-bottom: 3px">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="custom-control custom-checkbox lt">
                                        <input type="checkbox" name="api_share_to[]" value="qq" class="custom-control-input api_share_to" required {{ old('api_share_to') ? (in_array('qq', old('api_share_to')) ? 'checked' : '')  : '' }} required>
                                        <span class="custom-control-indicator"></span>
                                ...
                                <div class="col-md-4">
                                    <label class="custom-control custom-checkbox lt">
                                        <input type="checkbox" name="api_share_to[]" value="headlines" class="custom-control-input api_share_to" required {{ old('api_share_to') ? (in_array('headlines', old('api_share_to')) ? 'checked' : '')  : '' }} required>
                                        <span class="custom-control-indicator"></span>
                    ...
                    <div class="form-group row{{ $errors->has('download_resolution') ? " has-danger" : "" }}" id="video_download" {{ (!old('payment_mode') || old('payment_mode') == 'revenue-share') ? 'hidden' : '' }}>
                        <label class="col-md-3 control-label">{{ __('manage/cp/exchange/marketplace_terms.video_download') }}</label>
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="custom-control custom-checkbox lt">
                                        <input type="checkbox" name="download_resolution[]" value="hd" class="custom-control-input download_resolution" {{ old('download_resolution') ? (in_array('hd', old('download_resolution')) ? 'checked' : '')  : '' }}>
                                        <span class="custom-control-indicator"></span>
                                ...
                                <div class="col-md-4">
                                    <label class="custom-control custom-checkbox lt">
                                        <input type="checkbox" name="download_resolution[]" value="low" class="custom-control-input download_resolution" {{ old('download_resolution') ? (in_array('low', old('download_resolution')) ? 'checked' : '')  : '' }}>
                                        <span class="custom-control-indicator"></span>
...
<script>
    ...
    var allowedRegion = {!! old('allowed_regions') ? json_encode(old('allowed_regions')) : json_encode([]) !!};
	var exceptedRegion = {!! old('excepted_regions') ? json_encode(old('excepted_regions')) : json_encode([]) !!};
    var regions = {!! json_encode($regions) !!};
    showPaymentDetail('{{ old('payment_mode') }}');
    function showPaymentDetail(id) {
        ...
        if (id == "revenue-share") {
            ...
            $("#video_download").find('input[type="checkbox"]').prop("required", false)
        } else {
            $("#video_download").prop("hidden", false).siblings(".form-group").css("margin-bottom","20px")
            $("#video_download").find('input[type="checkbox"]').prop("required", true);
        }
