    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                {{ Form::open(['url' => route('manage.cp.request-logs.comment.store', [$property_id, $item->id, $type]), 'method'=>'PUT', 'class'=>'form-horizontal']) }}
                    {{ csrf_field() }}
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <textarea class="form-control-area" id="exampleTextarea" name="comments" rows="10" style="max-width: 100%">{{ $item->comment }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div> <!-- /.ibox -->
