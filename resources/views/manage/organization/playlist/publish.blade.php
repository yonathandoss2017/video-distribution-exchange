    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="form">
                    {{ Form::model($playlist, ['method'=>'PUT', 'url'=>route('manage.organization.playlists.publish.update', $playlist->id), 'id' => 'playlist_form', 'class'=>'form-horizontal', 'files' => true]) }}
                        <div class="title-header ">
                            <a href="{{ route('manage.organization.playlists.index') }}" class="btn btn-normal btn-m">{{ __('manage/cp/contents/playlists.back_to_playlists') }}</a>
                            ...
                            <div class="ibox-content">
                                <div class="form-group row mb-0 {{ $errors->has('radio_publish') ? " has-danger" : "" }}">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <label class="custom-control custom-radio">
                                            <input type="radio" name="radio_publish" value="off" id="radio-publish-off" class="custom-control-input" {{ (old('radio_publish') == 'off' || (!@$playlist->publish)) ? 'checked' : '' }}>
                                            <span class="custom-control-indicator"></span>
                                ...
                                <div id="marketplace-publish" style="margin-top: 20px; {{ old('radio_publish') == 'on' || (!old('radio_publish') && !empty($playlist) && $playlist->publish) ? '' : 'display: none;' }}">
                                    <div class="form-group row {{ $errors->has('marketplace_terms') ? " has-danger" : "" }}">
                                        ...
                                        <div class="col-md-9">
                                            <select name="marketplace_terms" class='form-control' id="marketplace-terms" required>
