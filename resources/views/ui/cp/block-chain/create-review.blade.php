...
<head>
  ...
  <title>全球视频聚合分发平台 | 查看存证视频 — xh-test</title>
  <!-- Bootstrap core CSS -->
...
<body cz-shortcut-listen="true">
      ...
      <div class="main-menu desktop">
        ...
        <div class="navi">
          <ul class="nav">
            ...
            <li class="dropdown main-nav-menu">
              <a class=" dropdown-toggle active" data-toggle="dropdown" href="#" aria-expanded="true">版权管理 <i class="fa fa-caret-down" aria-hidden="true"></i></a>
              <ul class="dropdown-menu">
                <li><a href="http://cnctest.ivideocloud.cn/manage/1/cp/block-chain" class="active">华视链专区</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="title-header ">
                        <div class="title">查看存证视频 — xh-test</div>
                    </div>
                    <div class="ibox">
                        ...
                        <div class="video-list dpp-video">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th class="image"></th>
                                        <th class="video-name fx-video-name">标题</th>
                                        <th class="duration">保全单位</th>
                                ...
                                <tbody>
                                  <tr>
                                        <td class="image">
                                            <div class="video-img">
                                                <a href="#"><img src="http://cnctest.ivideocloud.cn/serve/image/1/video/13/1548298165?width=240"></a>
                                            </div>
                                        </td>
                                        <td class="video-name fx-video-name">
                                            <a href="javascript:void(0)" data-toggle="modal" data-target="#modal-video13" onclick="getPlayer('13')">CarrotCakeOatmeal</a>
                                        </td>
                                        <td class="duration">cnc</td>
                                        <td>
                                            <a class="btn btn-normal btn-m delete" data-id="13" onclick="showConfirmDelete(this);"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="dataTables_info">显示 1 到 1 共有 1 个视频</div>
                                </div>
                                <div class="col-sm-7">
                                ...
                                <div class="form-save"><button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#submit">提交存证请求</button></div>
                            </div>
        </div>
            ...
            <div class="modal-dialog s-width" role="document">
                <div class="modal-content">
                 <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">提交存证请求</h5>
                    ...
                    <div class="modal-footer">
                        <form method="POST" action="http://cnctest.ivideocloud.cn/manage/1/cp/block-chain/store" accept-charset="UTF-8" class="form-horizontal" id="add-form"><input name="_token" type="hidden" value="QuBqDPvewe1QG59ZOOBjMDihiSorWvGhSFK6JTv0">
                            <input type="hidden" name="selectedList" id="selectedList" value="13">
                            <input type="hidden" name="playlistId" id="playlistId" value="1">
        ...
        <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog s-width" role="document">
                <div class="modal-content">
                 <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">确认移除视频</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-secondary" onclick="deleteVideo();">删除</button>
                    </div>
                </div>
            </div>
        </div>
  ...
  <!-- Bootstrap core JavaScript
    ...
    <script type="text/javascript" src="http://cnctest.ivideocloud.cn/js/block-chain/create.js"></script>
    <script>
      $(function () {
