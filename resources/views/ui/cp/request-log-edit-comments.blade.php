...
<html lang="en">
  <head>
    ...
    <title>iVideoExchange | {{ __('manage/cp/exchange/request_logs.edit_comments') }}</title>
    <!-- Bootstrap core CSS -->
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="title-header">
                    <div class="title">{{ __('manage/cp/exchange/request_logs.add_comments') }}</div>
                </div> <!-- /.title-header -->
                <form action="" class="form-horizontal">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5>{{ __('manage/cp/exchange/request_logs.add_comments') }}</h5>
                        </div>
                        <div class="ibox-content">
                            <div class="form-group row">
                                <label class="col-md-3 control-label" for="comments">{{ __('manage/cp/exchange/request_logs.comments') }}</label>
                                <div class="col-md-9">
                                    <textarea class="form-control-area" id="exampleTextarea" name="comments" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </div> <!-- /.ibox -->
