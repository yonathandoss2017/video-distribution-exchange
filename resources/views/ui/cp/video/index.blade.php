              ...
              <div class="col-md-11">
                <div class="right-panel">
                  <div class="status-float">
                    <a href="http://cnctest.ivideocloud.cn/manage/144/cp/videos/add" class="btn btn-normal m-r">新视频</a>
                  </div>
                  <div class="status-float">
                    <a href="javascript:void(0)" class="btn btn-normal m-r" id="import">导入</a>
                    <form method="POST" action="http://cnctest.ivideocloud.cn/manage/144/cp/videos/import/bulk" accept-charset="UTF-8" id="import-form" enctype="multipart/form-data"><input name="_token" type="hidden" value="dhyPgEyob4DfoU4Feu59TxVtKsT8nDF3chb36anN">
                      <input class="hidden" accept=".csv" id="uploadCsv" name="csv_file" type="file">
                    </form>
                  </div>
                  <div class="status-float">
                    <a href="#" class="btn btn-normal dropdown-toggle m-r" data-toggle="dropdown">批量操作 <i class="fa fa-caret-down" aria-hidden="true"></i></a>
                    <ul class="dropdown-menu">
                      <li><a href="javascript:void(0)" onclick="bulk_action(0);">请求审核</a></li>
                      <li><a href="javascript:void(0)" onclick="bulk_action(2);">导出</a></li>
                      <li><a href="javascript:void(0)" onclick="bulk_action(1);">删除视频</a></li>
                  ...
                  <div class="status-float">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="http://cnctest.ivideocloud.cn/manage/144/cp/videos?status=draft&amp;playlist=&amp;search=&amp;sort=">草稿</a></li>
                      <li><a href="http://cnctest.ivideocloud.cn/manage/144/cp/videos?status=ready&amp;playlist=&amp;search=&amp;sort=">就绪</a></li>
                      <li><a href="http://cnctest.ivideocloud.cn/manage/144/cp/videos?status=processing&amp;playlist=&amp;search=&amp;sort=">处理中</a></li>
                      <li><a href="http://cnctest.ivideocloud.cn/manage/144/cp/videos?status=pending&amp;playlist=&amp;search=&amp;sort=">待审核</a></li>
                      <li><a href="http://cnctest.ivideocloud.cn/manage/144/cp/videos?status=rejected&amp;playlist=&amp;search=&amp;sort=">被拒</a></li>
                      <li><a href="http://cnctest.ivideocloud.cn/manage/144/cp/videos?status=scheduled&amp;playlist=&amp;search=&amp;sort=">已排期</a></li>
                      <li><a href="http://cnctest.ivideocloud.cn/manage/144/cp/videos?status=error&amp;playlist=&amp;search=&amp;sort=">错误</a></li>
                    </ul>
                  </div>
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th class="video-name fx-video-name">名称 / 列表</th>
                      <th class="duration">时长</th>
                      <th class="duration">特色</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="features">
                        <!-- ai censorship -->
                        <i class="fa fa-shield text-grey" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="智能审核"></i>
                        <!-- block chain -->
                        <i class="fa fa-copyright text-grey" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="未使用区块链保护"></i>
                      </td>
                      <td class="date">
